...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "frame-ancestors " + os.getenv("FRONT_DNS_NAME") + " 'self' "
    }
}
...
#  Choices: any of ['blake2b', 'sha384', 'md5', 'blake2s', 'sha256', 'sha1', 'sha512', 'sha224', 'sha3_384', 'sha3_224', 'sha3_256', 'sha3_512']
#  Default: 'sha256'
